  ...
  if (!user) {
    return (
      <div className="flex min-h-0 flex-1 flex-col">
        ...
        />
        <div className="flex min-h-0 flex-1 flex-col items-center justify-center overflow-y-auto bg-gray-50/30 p-4 pb-[calc(6rem+env(safe-area-inset-bottom))] md:p-6 md:pb-6">
